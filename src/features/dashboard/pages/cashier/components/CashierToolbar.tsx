...
export default function CashierToolbar() {
  ...
  const toggleAddSessionFormVisibility = () => {
    setIsAddSessionFormVisible(true)
  }
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
      ...
      <Button onClick={toggleAddSessionFormVisibility} className="w-full sm:w-auto">
